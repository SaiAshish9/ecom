...
Code sent to
<span style={{fontSize:16,paddingLeft:10}} className={classes.primary} >
    +91 0987654321
</span>
</Typography>
...
<Typography  className={classes.label} style={{fontSize:14,margin:'5px 0 10px',marginBottom:'20px'}} >
Didn't receive the code yet?
<span style={{cursor:'pointer',fontSize:16,paddingLeft:10}} className={classes.primary} >
RESEND OTP
</span>
</Typography>
