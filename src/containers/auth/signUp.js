...
checked={true}
/>
    I agree with the Terms & Conditions of
<span style={{fontSize:12,paddingLeft:10}} className={classes.primary} >
    ecom
</span>
</Typography>
...
style={{cursor:'pointer',fontSize:14,paddingLeft:10}} className={classes.primary} >
    LOGIN
</a>
</Typography>
</Grid>
