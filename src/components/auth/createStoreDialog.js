...
<Box style={{marginBottom:'7vh'}} display="flex" flexDirection="column" justifyContent="space-between" >
<Typography  style={{textTransform: 'uppercase',color:'#999',marginLeft:'2vw'}}>
