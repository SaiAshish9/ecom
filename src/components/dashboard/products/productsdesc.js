    ...
    <Grid className={classes.grid}>
      <Grid style={{ display: "flex", alignItems: "center", width: "80vw" }}>
        <Grid style={{ display: "flex", alignItems: "center", width: "100%" }}>
          ...
          <Typography className={classes.dark}>Add New Product</Typography>
        </Grid>
      ...
      <Paper className={classes.form}>
        <Grid className={classes.grid1}>
          ...
          <Grid style={{ position: "relative", bottom: "10vh" }}>
            <Badge
              ...
              badgeContent={<CloseIcon className={classes.icon} />}
            >
              <Avatar
                src="https://www.nivea.in/-/media/local/in/boday_page/3_banner_3080x806.png?rx=626&ry=0&rw=2063&rh=806"
                variant="rounded"
        ...
        <Grid className={classes.grid2}>
          ...
          <TextField type="text" select={true} label="CATEGORY" />
        </Grid>

        <Grid style={{ height: "50vh" }} className={classes.grid2}>
          <TextField type="text" label="NAME IN ARABIC" placeholder="عربى" />

          <TextField type="text" label="QUANTITY" placeholder="Add Quantity" />

          <TextField type="text" label="WEIGHT" placeholder="1kg" />
        </Grid>
      </Paper>
      ...
      <Paper className={classes.form1}>
        ...
        >
          ...
          <Typography className={classes.label}>
            You can add options like color,size,extra,special requests etc to
            the product
          </Typography>
        </Grid>
        <Grid>
            ...
            style={{
              ...
              display:
                history.location.pathname ===
                  "/dashboard/product/products/edit/options/edit" && "none",
            }}
          >
            SAVED OPTIONS
          </Button>
