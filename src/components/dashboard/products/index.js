...
const Product = () => {
    return (
        <Switch>
            ...
            <Route path="/dashboard/product/products/edit/options" component={ProductsDesc} />
            <Route path="/dashboard/product/products/edit/options/edit" component={ProductsDesc} />
        </Switch>
    )
}
