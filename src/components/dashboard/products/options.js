  ...
  return (
    <Box display="flex" flexDirection="column">
      <Box className={classes.box} display="flex">
        <Box display="flex" flexDirection="column" className={classes.box1}>
          <Paper
            style={{
              width: "100%",
              height: "16vh",
          ...
          >
            ...
            >
              ...
              >
                ...
                <ButtonGroup className={classes.btnGrp}>
                  <Button className={classes.btn1}>Min</Button>
                  <Button className={classes.btn1}>Max</Button>
                </ButtonGroup>
              </Box>
            </Box>
            ...
            >
              <Box display="flex" alignItems="center">
                <IconButton>
                  <AddIcon style={{ fontSize: 18 }} className={classes.light} />
                </IconButton>
                <Typography className={classes.light}>Add Something</Typography>
              </Box>
            </Box>
          </Paper>
          ...
          >
            ...
            >
              <Typography className={classes.light}>Blue</Typography>
              <Typography className={classes.light}>Black</Typography>
              <Typography className={classes.light}>Brown</Typography>
            </Box>
          </Paper>
        ...
        <Box display="flex" flexDirection="column" className={classes.box1}>
          ...
          >
            ...
            >
              <Typography className={classes.light}>L</Typography>
              <Typography className={classes.light}>M</Typography>
              <Typography className={classes.light}>S</Typography>
            </Box>
          </Paper>
