...
<Paper
style={{width:'50%',height:'17vh',marginTop:'5vh',padding:20}}
...
<Grid className={classes.desc} style={{width:'50%',marginTop:'-5vh'}}>



<Grid style={{justifyContent:'space-around',display:'flex',flexWrap:'wrap',margin:'10px 0'}} className={classes.descPart}>
...
<Paper
key={k}
style={{width:'100%',minHeight:'20vh',display:'flex',flexDirection:'column'}}
className={classes.paper}>
<Grid style={{alignItems: 'center',height:'5vh'}} className={classes.grid1}>
<Typography style={{fontSize:15,margin:'20px'}} className={classes.logoTxt}>
{i}
</Typography>
<Grid style={{margin:'20px',display:'flex',alignItems:'center'}}
>
...
<Grid>
<Grid style={{paddingLeft:20,margin:'10px 0',display:'flex',alignItems:'center',width:'100%'}}>
<Checkbox check={true}/>
<Typography  className={classes.dark} style={{fontSize:12}}>
Pay Service Charges
</Typography>
