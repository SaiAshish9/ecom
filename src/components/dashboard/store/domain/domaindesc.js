  ...
  return (
    <Grid lg={9} className={classes.grid}>
      <Paper className={classes.form}>
        ...
        >
          <IconButton onClick={() => history.push("/dashboard/store/domain")}>
            <ArrowBackIcon />
          </IconButton>

          <Typography className={classes.logoTxt}>Primary Domain</Typography>
        </Grid>
        ...
        <Grid className={classes.desc}>
          ...
          >
            <Typography className={classes.logoTxt}>DNS</Typography>
          ...
          <Grid
            ...
            className={classes.descPart}
          >
            <Typography className={classes.logoTxt}>Manage</Typography>

            <Grid>
              <Typography className={classes.light}>NAME</Typography>

              <Typography className={classes.dark}>John Doe</Typography>
            </Grid>

            <Grid>
              <Typography className={classes.light}>ADDRESS</Typography>

              <Typography className={classes.dark}>19 Koss Landing</Typography>
            </Grid>
            <Grid>
              <Typography className={classes.light}>CONTACT NUMBER</Typography>

              <Typography className={classes.dark}>+91234567890</Typography>
            </Grid>

            <Grid>
              <Typography className={classes.light}>EMAIL</Typography>
