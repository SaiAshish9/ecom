...
<Route  path="/dashboard/store/domain" component={Domain}/>
<Route  path="/dashboard/store/shipping" component={Shipping}/>
<Route  path="/dashboard/store/locations" component={Locations}/>
<Route  path="/dashboard/store/payment" component={Payment}/>
