...
<Grid style={{width: '100%',display: 'flex',alignItems:'center',justifyContent:'space-between'}}>
...
{
    options.map((i,k)=>(
<Grid key={k} style={{margin:'10px 0',width: '100%',display: 'flex',justifyContent:'space-between'}}>
