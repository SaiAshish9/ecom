...
<IconButton
onClick={
    ()=>history.push('/dashboard/store/locations')
}
>
<ArrowBackIosIcon/>
</IconButton>
...
<Paper elevation={0} className={classes.disabled} style={{width:'40%'}} >
Burger King
...
<Typography style={{margin:'10px'}} component="div" className={classes.label} >
    Sharq
</Typography>  
