...
<Paper elevation={0} className={classes.first} style={{flexDirection:'column'}}>
...
<Paper elevation={0} className={classes.first} style={{flexDirection:'column',marginTop:'7vh',opacity:0.3,background:'#f4f4f4'}}>
<label className={classes.labellt} style={{fontSize:15}}>
Local Shipping Companies
</label>
<Divider style={{margin:10}} />
<Grid style={{display: 'flex',justifyContent:'space-between',alignItems:'center',width: '100%',minWidth:'20vw'}}>
<label className={classes.label} style={{fontSize:20,maxWidth:'50%'}}>
Aramex
</label>
<Switch
checked={true}
