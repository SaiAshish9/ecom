...
<FingerprintIcon style={{color:'#565a61',cursor:'pointer'}} />
</IconButton>
        </Avatar>
      </Badge>
...
<GoCheck className={k===0 && classes.plus1} style={{display:k!==0&&'none'}}/>


      </CardActionArea>
 
 {k===2&&(
    <CardContent style={{color:'white',background:'#46ac07',height:'4vh',display:'flex',alignItems:'center'}}>
          <Typography  gutterBottom style={{fontSize:12,fontWeight:'lighter',color:'#d5ecc7'}}>
            But this theme for {' '}
          </Typography>  
          <Typography  gutterBottom style={{marginLeft:2,fontSize:12}}>
         {' '} KWD 4.0
          </Typography>                 
        </CardContent>
 )}
...
Alpha Romoe
        ...
        <Divider style={{height:'5vh'}} orientation="vertical" flexItem />
<IconButton>
