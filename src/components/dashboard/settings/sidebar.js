...
const Sidebar = ({ classes, history }) => {
  const settings = [
    ...
    },
    {
      title: "Subscription",
      icon: <BsCreditCard />,
      links: ["/dashboard/settings/Subscription"],
    },
    {
      title: "ECOM Balance",
      icon: <FaBalanceScale />,
      links: ["/dashboard/settings/balance"],
    },
    {
      title: "Language",
      icon: <AiOutlineComment />,
      links: ["/dashboard/settings/language"],
    },
    {
      title: "Contact Us",
      icon: <ContactPhoneIcon />,
      links: ["/dashboard/settings/contact"],
    },
    {
      title: "Preferences",
      icon: <BsGrid1X2 />,
      links: ["/dashboard/settings/preferences"],
    },
    {
      title: "Privacy Policy",
      icon: <RiGitRepositoryPrivateLine />,
      links: ["/dashboard/settings/privacy"],
    },
    {
      title: "Terms & Conditions",
      icon: <BsFileEarmarkRuled />,
      links: ["/dashboard/settings/terms"],
    },
  ];
