    ...
    >
      <Paper className={classes.form}>
        <Grid className={classes.inputsCont}>
          ...
          <input type="text" placeholder="Azaa" className={classes.txtInput} />
          ...
          <label className={classes.label}>STORE NAME</label>

          <input type="text" placeholder="Azaa" className={classes.txtInput} />

          <label className={classes.label}>STORE NAME IN ARABIC</label>
