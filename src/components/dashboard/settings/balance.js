...
<Grid style={{alignItems:'center', display:'flex',height:'7vh',marginBottom:'3vh'}} >



<Paper elevation={0} style={{justifyContent:'space-between',padding:10,marginLeft:'25%',width:'30vw',height:'6vh',display:'flex',alignItems:'center'}}>
...
<Typography style={{display:'flex',alignItems:'center'}} className={classes.dark}>
...
data.map((i,k)=>(
<Grid key={k} >
<Grid style={{display:'flex',padding:'2rem 2rem 1rem',justifyContent:'space-between',alignItems:'center'}}>
<Grid>
<label className={classes.dark}>{i.title}</label>
<br/>
<label className={classes.label} style={{fontSize:10}}>04:40 pm - 17 June,2019</label>
</Grid>
<Grid>
<Typography className={ i.qty.includes('+')?classes.green:classes.red}>
{i.qty}
</Typography>
<label className={classes.label}>
{i.desc}
